<script lang="ts">
    ...
    const transformers = [
        transformerCopyButton({
            ...
            cssVariables: `:root {
  --button-border-color: light-dark(rgb(0 0 0 / 0.12), rgb(255 255 255 / 0.12));
  --button-bg: light-dark(rgb(0 0 0 / 0.03), rgb(255 255 255 / 0.04));
  --button-bg-hover: light-dark(rgb(0 0 0 / 0.08), rgb(255 255 255 / 0.1));
  --button-top: 10px;
  --button-right: 10px;
  --button-z-index: 10;
  --button-radius: 6px;
...
<div class="code-snippet overflow-hidden rounded-lg border border-line bg-code">
    <CodeBlock {code} {lang} themes={{ light: "vitesse-light", dark: "vitesse-black" }} defaultColor="light-dark()" {transformers} />
</div>
...
<style>
    ...
    .code-snippet :global(code) {
        ...
        scrollbar-color: light-dark(rgb(0 0 0 / 0.2), rgb(255 255 255 / 0.2)) transparent;
